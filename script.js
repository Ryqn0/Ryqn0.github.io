const translations = {
  en: {
    ...
    'project-amf-rag-agent-description': 'Bilingual (FR/EN) Q&A agent over real financial filings from the Autorité des Marchés Financiers. It combines hybrid retrieval — BM25 and Elasticsearch keyword search with semantic search, reranked by a cross-encoder — and an agent powered by the Anthropic and OpenAI APIs. Live demo: https://huggingface.co/spaces/Ryqn/amf-rag-agent. Built with production practices: evaluation metrics, CI/CD, containerized and deployable on Kubernetes, with metrics monitoring.',
    'resume-title': 'Resume',
