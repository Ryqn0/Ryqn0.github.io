const translations = {
  en: {
    ...
    'project-amf-rag-agent-title': 'Bilingual Q&A AMF RAG Agent',
    ...
    'project-amf-rag-agent-description': 'Bilingual (FR/EN) Q&A agent over real financial filings from the Autorité des Marchés Financiers. It combines hybrid retrieval — BM25 and Elasticsearch keyword search with semantic search, reranked by a cross-encoder — and an agent powered by the Anthropic and OpenAI APIs. Live demo: <a href=https://huggingface.co/spaces/Ryqn/amf-rag-agent>https://huggingface.co/spaces/Ryqn/amf-rag-agent</a>. Built with production practices: evaluation metrics, CI/CD, containerized and deployable on Kubernetes, with metrics monitoring.',
    'resume-title': 'Resume',
  ...
  fr: {
    ...
    'project-amf-rag-agent-title': "Agent RAG de Q&A sur des documents AMF",
    'project-status-wip': 'En cours',
    'project-amf-rag-agent-description': "Agent de questions-réponses bilingue (FR/EN) sur des documents financiers réels déposés auprès de l'Autorité des marchés financiers. Il combine une recherche hybride — recherche par mots-clés (BM25, Elasticsearch) et recherche sémantique, réordonnée par un cross-encoder — et un agent propulsé par les API d'Anthropic et d'OpenAI. Démo en ligne : <a href=https://huggingface.co/spaces/Ryqn/amf-rag-agent>https://huggingface.co/spaces/Ryqn/amf-rag-agent</a>. Construit selon des pratiques de production : métriques d'évaluation, CI/CD, conteneurisé et déployable sur Kubernetes, avec monitoring des métriques.",
